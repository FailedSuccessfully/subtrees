Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/797d03e411734f9448698f90cdf6408f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				#if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
				float4 rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RimTexUV*/)], _RimTex_ST), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_RimLightColorThemeIndex*/)), float4(1,1,1,1).a);
				#else
