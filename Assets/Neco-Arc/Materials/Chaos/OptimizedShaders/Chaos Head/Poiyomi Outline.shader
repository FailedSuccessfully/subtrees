Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/423cc4757e9a94e4f9cdf697b9dd98ec"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				#if defined(PROP_RIMMASK) || !defined(OPTIMIZER_ENABLED)
				float rimMask = POI2D_SAMPLER_PAN(_RimMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RimMaskUV*/)], float4(0.33333,0.33333,0,0)), float4(0,0,0,0));
				#else
				float rimMask = 1;
				#endif
				#if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
