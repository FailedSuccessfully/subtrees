Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/9a596b5adf4632c4b81ae87857a40530"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((3.0 /*_LightingColorMode*/) == 3)
				{
					...
					poiLight.indirectColor = max(poiLight.indirectColor, (0.04 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor / max(0.0001, (calculateluminance(poiLight.directColor) / (0.04 /*_LightingMinLightBrightness*/))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor / max(0.0001, (calculateluminance(poiLight.indirectColor) / (0.04 /*_LightingMinLightBrightness*/))));
				}
